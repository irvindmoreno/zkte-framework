...
var SliderMiBlog = (function () {
	//documentacion:http://pgwjs.com/pgwslider/

	function SliderMiBlog() {
		_classCallCheck(this, SliderMiBlog);
    ...
    */
			;(function ($) {
				$.fn.pgwSlider = function (options) {
					...
					var updateHeight = function updateHeight(height, animate) {
					...
					// Set size class
					var setSizeClass = function setSizeClass() {
					...
					// Finish element
					var finishElement = function finishElement(element) {
					...
					// Fade an element
					var fadeElement = function fadeElement(element) {
					...
					// Slide an element
					var slideElement = function slideElement(element, direction) {
						var elementContainer = pgwSlider.plugin.find('.ps-current > ul');
					...
					var displayElement = function displayElement(elementId, apiController, direction) {
					...
					// Activate interval
					var activateInterval = function activateInterval() {
						clearInterval(pgwSlider.intervalEvent);
...
var TituloService = function TituloService() {
	_classCallCheck(this, TituloService);
};

var PostCuda = function PostCuda() {
	_classCallCheck(this, PostCuda);
};